...
const CONVERSATIONS: Conversation[] = [
  { id: "c1", name: "Olivia Martin", role: "Customer", lastMessage: "Thank you for the quick refund!", time: "5m", unread: 2, online: true, gradient: "from-pink-500 to-rose-600" },
  { id: "c2", name: "Emma Garcia", role: "Pro Customer", lastMessage: "Can I book a table for 8 PM?", time: "32m", unread: 0, online: true, gradient: "from-violet-500 to-purple-600" },
  { id: "c3", name: "Alex (Admin)", role: "FoodHub Support", lastMessage: "Your store has been verified!", time: "1h", unread: 1, online: false, gradient: "from-blue-500 to-cyan-600" },
  { id: "c4", name: "Carlos Rivera", role: "Delivery Boy", lastMessage: "I'll be there in 5 minutes.", time: "2h", unread: 0, online: false, gradient: "from-emerald-500 to-teal-600" },
  { id: "c5", name: "Liam Chen", role: "Customer", lastMessage: "Is the Margherita vegetarian?", time: "5h", unread: 0, online: true, gradient: "from-amber-500 to-orange-600" },
  { id: "c6", name: "Sophia Patel", role: "Customer", lastMessage: "Loved the food! Will order again.", time: "1d", unread: 0, online: false, gradient: "from-rose-500 to-pink-600" },
];

const MESSAGES: Message[] = [
  { id: 1, conversationId: "c1", sender: "them", text: "Hi! I had an issue with my last order.", time: "10:24 AM" },
  { id: 2, conversationId: "c1", sender: "me", text: "Hi Olivia! Sorry to hear that. What happened?", time: "10:26 AM" },
  { id: 3, conversationId: "c1", sender: "them", text: "The delivery was 30 minutes late and the food was cold.", time: "10:28 AM" },
  { id: 4, conversationId: "c1", sender: "me", text: "I'm really sorry about that. I've issued a full refund to your wallet.", time: "10:30 AM" },
  { id: 5, conversationId: "c1", sender: "them", text: "Thank you for the quick refund!", time: "10:36 AM" },
];
...
export default function VendorMessages() {
  ...
  return (
    <div>
      <PageHeader
        title="Messages"
        description="Chat with customers, delivery partners, and FoodHub support"
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 h-full">
          ...
          <div className={cn("md:col-span-2 flex flex-col", !selectedId && "hidden md:flex")}>
                ...
                >
                  <Avatar className="w-7 h-7 rounded-full shrink-0">
                    <AvatarFallback className={cn(
                      ...
                      m.sender === "me" ? "bg-emerald-600" : `bg-gradient-to-br ${selected.gradient}`,
                    )}>
                      {m.sender === "me" ? "ME" : selected.name.split(" ").map((s) => s[0]).slice(0, 2).join("")}
                    </AvatarFallback>
                  </Avatar>
                  <div className={cn(
            ...
            <div className="p-3 border-t border-[#E5E7EB] flex items-center gap-2">
              ...
              />
              <Button onClick={send} disabled={!draft.trim()} className="h-10 w-10 rounded-lg bg-emerald-600 hover:bg-emerald-700 shrink-0">

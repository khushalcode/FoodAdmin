...
// GET /api/loyalty-points?customerId=&limit=50 OR no params (returns all)
// Returns: list of {id, userId, userName, credit, debit, balance, transactionType, reference, createdAt}
// Source: loyalty_point_transactions joined with users(name)
  ...
  try {
    ...
    let q = adminSupabase
      ...
      .select(`
        ...
        user:users!loyalty_point_transactions_user_id_fkey(name, email)
      `)
